...
coeffs = {
    'metopb': {'ah': np.array([0.174, 0.179, 0.210]),
               'al': np.array([0.058, 0.060, 0.030]),
               'bh': np.array([-2.747, 3.557, -2.267]),
               'bl': np.array([-2.747, 3.557, -2.267]),
               'ch': np.array([1.156, -0.410, 1.498]),
               'cl': np.array([1.156, -0.410, 1.498]),
               ...
               'c_wn': np.array([2664.3383, 933.71521, 839.72764]),
    ...
    'metopa': {'ah': np.array([0.167, 0.199, 0.220]),
               ...
               'bh': np.array([1.195, 1.092, 1.804]),
               'bl': np.array([1.195, 1.092, 1.804]),
               'ch': np.array([-0.066, -0.012, -0.080]),
               'cl': np.array([-0.066, -0.012, -0.080]),
    ...
    'noaa8': {'ah': np.array([0.118, 0.141, 0.0]),
              'al': np.array([0.118, 0.141, 0.0]),
              'bh': np.array([14.204, 17.467, 0.0]),
              'bl': np.array([14.204, 17.467, 0.0]),
              'ch': np.array([-3.021, -4.047, 0.0]),
              'cl': np.array([-3.021, -4.047, 0.0]),
              'c_dark': np.array([39.44, 39.40, 37.51]),
              'l_date': 1983.241,
              'd': np.array([[0, 0, 0, 0, 0],  # reset prt
                             [277.659, 0.051275, 1.363e-06, 0, 0],
    ...
    'noaa9': {'ah': np.array([0.108, 0.120, 0.0]),
              ...
              'bh': np.array([6.658, 5.341, 0.0]),
              'bl': np.array([6.658, 5.341, 0.0]),
              'ch': np.array([-0.082, -0.474, 0.0]),
              'cl': np.array([-0.082, -0.474, 0.0]),
    ...
    'noaa10': {'ah': np.array([0.103, 0.134, 0.0]),
               ...
               'bh': np.array([12.184, 3.684, 0.0]),
               'bl': np.array([12.184, 3.684, 0.0]),
               'ch': np.array([-2.010, -0.271, 0.0]),
               'cl': np.array([-2.010, -0.271, 0.0]),
               'c_dark': np.array([39.44, 39.40, 37.51]),
               'l_date': 1986.712,
               'd': np.array([[0, 0, 0, 0, 0],  # reset prt
                              [276.659, 0.051275, 1.363e-06, 0, 0],
    ...
    'noaa11': {'ah': np.array([0.112, 0.118, 0.0]),
               ...
               'bh': np.array([-0.863, -0.227, 0.0]),
               'bl': np.array([-0.863, -0.227, 0.0]),
    ...
    'noaa14': {'ah': np.array([0.118, 0.150, 0.0]),
               ...
               'bh': np.array([5.613, 2.325, 0.0]),
               'bl': np.array([5.613, 2.325, 0.0]),
               'ch': np.array([-0.584, -0.039, 0.0]),
               'cl': np.array([-0.584, -0.039, 0.0]),
    ...
    'noaa15': {'ah': np.array([0.182, 0.208, 0.0]),
               'al': np.array([0.061, 0.069, 0.0]),
               'bh': np.array([-0.332, 0.338, 0.0]),
               'bl': np.array([-0.332, 0.338, 0.0]),
               'ch': np.array([0.013, -0.016, 0.0]),
               'cl': np.array([0.013, -0.016, 0.0]),
    ...
    'noaa16': {'ah': np.array([0.169, 0.175, 0.209]),
               'al': np.array([0.056, 0.058, 0.030]),
               'bh': np.array([0.393, 2.555, -11.300]),
               'bl': np.array([0.393, 2.555, -11.300]),
               'ch': np.array([-0.010, -0.305, 4.218]),
               'cl': np.array([-0.010, -0.305, 4.218]),
    ...
    'noaa17': {'ah': np.array([0.176, 0.199, 0.217]),
               ...
               'bh': np.array([0.284, 3.457, 2.067]),
               'bl': np.array([0.284, 3.457, 2.067]),
               'ch': np.array([0.082, -0.302, -0.127]),
               'cl': np.array([0.082, -0.302, -0.127]),
    ...
    'noaa18': {'ah': np.array([0.168, 0.188, 0.0]),
               'al': np.array([0.056, 0.063, 0.0]),
               'bh': np.array([1.971, 1.937, 0.0]),
               'bl': np.array([1.971, 1.937, 0.0]),
               'ch': np.array([-0.110, -0.074, 0.0]),
               'cl': np.array([-0.110, -0.074, 0.0]),
               'c_dark': np.array([39.44, 39.40, 37.51]),
    ...
    'noaa19': {'ah': np.array([0.163, 0.182, 0.0]),
               'al': np.array([0.054, 0.061, 0.0]),
               'bh': np.array([1.241, 1.494, 0.0]),
               'bl': np.array([1.241, 1.494, 0.0]),
               'ch': np.array([-0.101, -0.075, 0.0]),
               'cl': np.array([-0.101, -0.075, 0.0]),
